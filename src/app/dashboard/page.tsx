        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <div className="space-y-2">
              ...
              {worker.preferredLearningTime && (() => { const hoursLabels: Record<string, string> = lang === "bn" ? { lt_1h: "১ ঘণ্টার কম", "1_2h": "১ - ২ ঘণ্টা", "2_3h": "২ - ৩ ঘণ্টা", gt_3h: "৩ ঘণ্টার বেশি" } : { lt_1h: "Less than 1 hour", "1_2h": "1 - 2 hours", "2_3h": "2 - 3 hours", gt_3h: "More than 3 hours" }; return <div className="flex items-center gap-2 text-xs"><span className="text-text-secondary w-20 shrink-0">{lang === "bn" ? "দৈনিক শেখার সময়" : "Daily Study Time"}:</span><span className="font-medium text-primary">{hoursLabels[worker.preferredLearningTime] || worker.preferredLearningTime}</span></div>; })()}
