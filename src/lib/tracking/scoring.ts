...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  content_writing: ["content", "writing", "article", "blog", "copywriting", "copy write", "blogging"],
  content_creation: ["content creation", "content creator", "monetization", "monetize", "creator", "vlogger"],
  instagram: ["instagram", "reels", "ig reel"],
  tiktok: ["tiktok", "shorts video", "short video"],
  podcast: ["podcast", "audio show"],
  social_media: ["social media management", "smm", "community manager", "page management", "social media"],
  ...
  spoken_english: ["spoken", "english", "ielts", "toefl", "grammar", "vocabulary", "study abroad", "student visa", "foreign university"],
  ...
  business: ["business", "startup", "entrepreneur", "ecommerce", "shopify", "amazon", "dropshipping", "online business"],
  job_preparation: ["job", "career", "interview", "resume", "cv", "bcs", "bank"],
  youtube: ["youtube channel", "youtube video", "youtube shorts", "content creator", "vlog"],
