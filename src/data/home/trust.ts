export const trustBadges = [
  ...
  { icon: "📱", textBn: "যেকোনো সময় সাপোর্ট", textEn: "Support Anytime" },
...
export const trustSectionData = {
  ...
  titleBn: "৩০ সেকেন্ডেই শুরু করুন আপনার শেখার যাত্রা!",
  titleEn: "Start Your Learning Journey in 30 Seconds!",
