...
> **Layer 1 (canonical):** [`docs/framework/`](framework/INDEX.md) — the immutable 13-part AIOS.
...
> - Every audit requirement MUST reference its governing AIOS Part (§ header in each audit doc).
> - If implementation conflicts with canonical AIOS, **the canonical AIOS takes precedence** (Part 13 §13.1).
> - Framework and implementation evolve independently; this matrix is refreshed whenever either changes.
> - **Updated:** 2026-08-05 (Phase A) — pending Phase B refreshes as new docs land.
...
|---|---|---|---|
| 01 Foundation | `01_SCOPE_AND_METHOD.md` (§1.5 truth & ethics) | — | ✅ |
...
## Section B — Audit Document → Governing AIOS Part (reverse guarantee)

| Audit document | Governing AIOS Part |
|---|---|
| `00_EXECUTIVE_SUMMARY.md` | 10 (+02) |
| `01_SCOPE_AND_METHOD.md` | 01 (+02, 04) |
| `02_COVERAGE_MATRIX.md` | 13 (+04 §4.6) |
| `03_ASSUMPTION_REGISTER.md` | 13 (+04 §4.3) |
| `04_CONFIDENCE_MATRIX.md` | 13 (+03 §3.5, 04 §4.3) |
| `05_CONTRADICTION_RESOLUTION_LOG.md` | 13 |
| `06_SELF_REVIEW_OPPORTUNITY_DISCOVERY.md` | 13 (+06, 07) |
| `10_PHASE1_LAUNCH_BLOCKERS.md` | 03 (+04 §4.4) |
...
| `40_RUNTIME_VERIFICATION.md` | 04 §4.5 (+03) |
| `40_MASTER_SCORECARD.md` | 10 (+03 §3.5) |
...
| Output | Tier | Governing Part |
|---|---|---|
| RT-<NN> static proofs (file:line) | ✅ static | 04 §4.3 |
| RT-<NN> runtime tests (deployed) | ⏱ runtime | 04 §4.5 |
| RT-<NN> production tests (real providers/load) | 🏭 production | 03 §3.1 (L6) |
...
| 2026-08-05 | Audit docs renamed to part-aligned names; P03–P12 deliverables completed (Phase B) — 40_MASTER_SCORECARD, 42_CI, 43_KM, extended 20/21/23/24/25/26 | L2 |
