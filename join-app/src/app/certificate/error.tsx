  ...
  return (
    <main className="min-h-screen flex items-center justify-center pt-20 px-4 bg-[#0a0a0a]">
      <div className="max-w-md w-full card-pop !rounded-[2rem] text-center p-8">
        ...
        <h1 className="mt-3 text-xl font-black text-slate-900">পেজ লোড করা যায়নি</h1>
        <p className="mt-2 text-xs leading-relaxed text-slate-600">
          সাময়িক সমস্যা হয়েছে। রিলোড করুন বা হোমে ফিরে আবার চেষ্টা করুন।
        </p>
        <p className="mt-2 text-[10px] font-mono text-slate-400 break-all">{error.message || "Unknown error"}</p>
        <div className="mt-4 flex gap-2">
          <button onClick={() => reset()} className="flex-1 py-2.5 rounded-xl bg-slate-100 border border-slate-200 text-slate-700 text-xs font-black">
            🔄 রিলোড করুন
          </button>
